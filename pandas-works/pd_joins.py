...
pd.merge(data_frame1,dataframe2,on="column",how="inner")  using when the coulmns are same
pd.merge(data_frame1,dataframe2,left_on="column_name",right_on="column_name",how="inner")  using when the coulmns are different and connect them
...
print("movies statistic =======================")
print(movies.columns)
print(movies.isnull().sum())
print("reviews statistic *****************")
